...
### Academic and Technical Text Humanization
For scientific, academic, and technical writing, the skill provides dedicated guidelines to rebuild text structure, vary sentence length (burstiness), eliminate generic transitions, explain precise physical/technical mechanisms, and inject a researcher-driven analytical voice.
...
- **2.6.0** - Added specialized academic and technical text humanization module (sentence rhythm variation, transition removal, mechanism-focused explanations, and analytical voice).
