...
assert_non_empty(file.path(output_dir, "data", "calibration_data.qs"))
assert_non_empty(file.path(output_dir, "table", "calibration_statistics.xlsx"))
assert_non_empty(file.path(output_dir, "plot", "calibration_curve.pdf"))
