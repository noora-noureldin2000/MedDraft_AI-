...
If any workflow step mentions a dataset, cohort, database, portal, registry, structure source, or public resource, the workflow section must begin with the following line exactly once before the first step:
...
Input:            Exact exposures / target resources / outputs from prior steps needed
...
1. **Exposure-Pair and Toxic-Phenotype Selection**
2. **Exposure-Target Retrieval and Toxic-Target Collection**
3. **Shared-vs-Specific Overlap Decomposition**
4. **GO / KEGG Enrichment**
5. **PPI Network Construction and Hub-Target Selection**
6. **Docking Design and Binding-Plausibility Review**
7. **Transcriptomic or Orthogonal Cross-Check**
