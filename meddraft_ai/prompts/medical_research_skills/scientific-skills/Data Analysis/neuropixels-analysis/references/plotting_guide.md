...
This guide details how to use Neuropixels data to create publication-quality visualizations.
...
### Motion Estimation Visualization
...
```python
# Comparing multiple units
unit_ids = [0, 1, 2, 3]
sw.plot_unit_templates(analyzer, unit_ids=unit_ids)
plt.savefig('template_comparison.png')
```

### Waveform Distribution on Probe

```python
# Display waveforms at probe spatial locations
...
### Relationship Between Metrics and Classification Labels
...
### ISI with Refractory Period Markers
...
### Manually Constructing Multi-panel Summary Plots
...
# Used for labeling good/mua/noise
