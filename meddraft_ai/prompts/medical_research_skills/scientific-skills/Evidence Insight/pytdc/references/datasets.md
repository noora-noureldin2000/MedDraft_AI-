# TDC Dataset Complete Catalog

This document provides a complete catalog of all available datasets in the Therapeutics Data Commons, organized by task category.
...
**Distribution:**
- `BBB_Martins` - Blood-brain barrier permeability (1,975 compounds)
...
- `hERG_Karim` - hERG blockers expanded dataset (13,445 compounds)
...
- `Tox21-AhR` - Aryl hydrocarbon receptor signaling pathway (8,169 compounds)
- `Tox21-AR` - Androgen receptor (9,362 compounds)
- `Tox21-AR-LBD` - Androgen receptor ligand binding domain (8,343 compounds)
...
- `Tox21-ER-LBD` - Estrogen receptor ligand binding domain (8,163 compounds)
...
- `QM7` - Quantum mechanical properties (7,160 molecules)
- `QM8` - Electronic spectra and excited states (21,786 molecules)
- `QM9` - Geometric, energetic, electronic, and thermodynamic properties (133,885 molecules)
...
- `IEDBpep-DiseaseBinder` - Disease-related epitope binding (6,080 peptides)
- `IEDBpep-NonBinder` - Non-binding peptides (24,320 peptides)

### Develop

- `Manufacturing` - Manufacturing success rate prediction
...
**Binary Interaction:**
- `BindingDB_Patent` - DTI from patents (8,503 pairs)
- `BindingDB_Approval` - DTI of FDA-approved drugs (1,649 pairs)

### DDI (Drug-Drug Interaction)

- `DrugBank` - Drug-drug interactions (191,808 pairs, 1,706 drugs)
- `TWOSIDES` - DDI based on side effects (4,649,441 pairs, 645 drugs)
...
- `PrimeKG_GDA` - Gene-disease associations from PrimeKG knowledge graph
...
- `USPTO_Catalyst` - Reaction catalyst prediction (11,000+ reactions)

### TrialOutcome (Clinical Trial Outcome)
...
- `Prodrug` - Prodrug-to-drug transformation (1,000+ pairs)
- `Metabolite` - Drug-to-metabolite transformation
...
- TDC regularly adds new datasets.
- Some datasets may require additional dependencies.
- Please visit the official TDC website for the latest list of datasets: https://tdcommons.ai/overview/