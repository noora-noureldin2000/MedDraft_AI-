...
Run: `./scripts/review_poster.py poster.pdf` or `./scripts/check_poster_quality.py poster.pdf` or manually verify:
...
- [ ] No fonts with subsetted outlines
...
- [ ] They can state main finding
- [ ] They remember key figure
