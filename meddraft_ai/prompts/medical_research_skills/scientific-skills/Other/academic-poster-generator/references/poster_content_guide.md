...
- ❌ Unnecessarily long: "Investigation of potential role of..."
...
\begin{tikzpicture}[node distance=2cm]
  ...
  \node [box, below of=start] {process} {Preprocessing\\Quality Control};
  \node [box, below of=process] {analysis} {Statistical Analysis\\Mixed Models};
  \node [box, below of=analysis] {end} {Validation\\Independent Cohort};
...
We thank Dr. X for data access, Y Core Facility for 
