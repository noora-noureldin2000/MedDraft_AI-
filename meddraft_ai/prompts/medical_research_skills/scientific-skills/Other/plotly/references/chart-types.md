...
A comprehensive guide to chart types organized by category.
...
# Custom error bars using graph_objects
...
# Mapbox (some styles require a token)
...
```python
# Usually built using scatter plots
fig = px.scatter(
    df,
    x='log2_fold_change',
    y='neg_log10_pvalue',
