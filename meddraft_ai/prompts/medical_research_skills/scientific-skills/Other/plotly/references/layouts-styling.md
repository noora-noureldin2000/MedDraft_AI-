# Layout, Styling, and Customization
...
# Add traces to specific locations
...
templates = [
    ...
    'simple_white',    # Minimalist white
    'presentation',    # For presentations
    'xgridoff',        # No x-axis grid
    'ygridoff',        # No y-axis grid
    'gridon',          # Grid on
    'none'             # No styling
]
...
# Set default template for the current session
...
# Session-level default settings
...
fig.update_coloraxes(
    colorbar=dict(
        ...
        tick0=0,
        dtick=10,
        len=0.7,           # Height relative to the chart
        thickness=20,
        x=1.02             # Position
    )
)
...
fig.update_layout(
    ...
    autosize=True  # Automatically resize to fit container
)
```
...
fig.update_layout(
    ...
    paper_bgcolor='white'      # Paper/Canvas background
)
```
