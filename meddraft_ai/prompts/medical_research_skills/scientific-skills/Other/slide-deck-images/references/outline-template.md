...
**Type**: Back Cover
**Filename**: {NN}-slide-back-cover.svg
...
|------------|--------------|---------|
| Cover | `cover` | `01-slide-cover.svg` |
| Content | `{topic-slug}` | `02-slide-problem-statement.svg` |
| Back Cover | `back-cover` | `10-slide-back-cover.svg` |
